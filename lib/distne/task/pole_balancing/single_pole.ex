...
#     pole_mass = 0.1
#     gravity = 9.801
#     hinge_friction_coeff = 0.000002
#     length = 0.5
#     eff_pole_mass = effective_pole_mass(pole_mass, state.angle)
#     eff_pole_force = effective_pole_force(pole_mass, length, state.angular_vel, state.angle, hinge_frinction_coeff, gravity)
